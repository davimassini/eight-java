...
public class IUCadastrarProduto extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					IUCadastrarProduto frame = new IUCadastrarProduto();
	...
	private JTextField cadNomeProduto = new JTextField();
	private JTextField cadDescProduto = new JTextField();
	private JTextField cadCodigoProduto = new JTextField();
	...
	public IUCadastrarProduto() {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setFont(new Font("Open Sans", Font.PLAIN, 12));
		setBounds(100, 100, 630, 680);
		setResizable(false);
		setIconImage(Toolkit.getDefaultToolkit().getImage(IUCadastrarProduto.class.getResource("/View/images/iconBarra.png")));	
		setUndecorated(true);
		setResizable(false);
		...
		lblLogoLog.setIcon(new ImageIcon(IUCadastrarProduto.class.getResource("/View/images/logo-footer-mini.png")));
		...
		cadCodigoProduto.setBounds(75, 215, 465, 40);
		cadCodigoProduto.setUI(new HintTextFieldUI("Código do produto", true));
		panelCadastrar.add(cadCodigoProduto);
		cadCodigoProduto.setForeground(Color.BLACK);
		cadCodigoProduto.setBackground(Color.WHITE);
		cadCodigoProduto.setFont(new Font("Gotham Book", Font.PLAIN, 13));
		cadCodigoProduto.setBorder(BorderFactory.createCompoundBorder(new LineBorder(Color.LIGHT_GRAY, 1, false), BorderFactory.createEmptyBorder(0, 10, 0, 0)));
		cadCodigoProduto.setColumns(10);
		
		cadNomeProduto.setUI(new HintTextFieldUI("Nome do produto", true));
		cadNomeProduto.setForeground(Color.BLACK);
		cadNomeProduto.setFont(new Font("Gotham Book", Font.PLAIN, 13));
		cadNomeProduto.setColumns(10);
		cadNomeProduto.setBorder(BorderFactory.createCompoundBorder(new LineBorder(Color.LIGHT_GRAY, 1, false), BorderFactory.createEmptyBorder(0, 10, 0, 0)));
		cadNomeProduto.setBackground(Color.WHITE);
		cadNomeProduto.setBounds(75, 266, 465, 40);
		panelCadastrar.add(cadNomeProduto);

		cadDescProduto.setBounds(75, 317, 465, 80);
		cadDescProduto.setUI(new HintTextFieldUI("Descrição do produto", true));
		panelCadastrar.add(cadDescProduto);
		cadDescProduto.setForeground(Color.BLACK);
		cadDescProduto.setBackground(Color.WHITE);
		cadDescProduto.setFont(new Font("Gotham Book", Font.PLAIN, 13));
		cadDescProduto.setBorder(BorderFactory.createCompoundBorder(new LineBorder(Color.LIGHT_GRAY, 1, false), BorderFactory.createEmptyBorder(-40, 10, 0, 0)));
		cadDescProduto.setColumns(10);
		
		cadPrecoProduto.setUI(new HintTextFieldUI("Preço do produto", true));
		cadPrecoProduto.setForeground(Color.BLACK);
		cadPrecoProduto.setFont(new Font("Gotham Book", Font.PLAIN, 13));
		cadPrecoProduto.setColumns(10);
		cadPrecoProduto.setBorder(BorderFactory.createCompoundBorder(new LineBorder(Color.LIGHT_GRAY, 1, false), BorderFactory.createEmptyBorder(0, 10, 0, 0)));
		cadPrecoProduto.setBackground(Color.WHITE);
		cadPrecoProduto.setBounds(75, 408, 465, 40);
		panelCadastrar.add(cadPrecoProduto);

		cadEstoqueProduto.setBounds(75, 459, 465, 40);
		cadEstoqueProduto.setUI(new HintTextFieldUI("Estoque do produto", true));
		panelCadastrar.add(cadEstoqueProduto);
		cadEstoqueProduto.setForeground(Color.BLACK);
		cadEstoqueProduto.setBackground(Color.WHITE);
		cadEstoqueProduto.setFont(new Font("Gotham Book", Font.PLAIN, 13));
		cadEstoqueProduto.setBorder(BorderFactory.createCompoundBorder(new LineBorder(Color.LIGHT_GRAY, 1, false), BorderFactory.createEmptyBorder(0, 10, 0, 0)));
		cadEstoqueProduto.setColumns(10);
		
		cadClassificacaoProduto.setUI(new HintTextFieldUI("Classificação do produto", true));
		cadClassificacaoProduto.setForeground(Color.BLACK);
		cadClassificacaoProduto.setFont(new Font("Gotham Book", Font.PLAIN, 13));
		cadClassificacaoProduto.setColumns(10);
		cadClassificacaoProduto.setBorder(BorderFactory.createCompoundBorder(new LineBorder(Color.LIGHT_GRAY, 1, false), BorderFactory.createEmptyBorder(0, 10, 0, 0)));
		cadClassificacaoProduto.setBackground(Color.WHITE);
		cadClassificacaoProduto.setBounds(75, 510, 465, 40);
		panelCadastrar.add(cadClassificacaoProduto);
		
		JButton btnCadastrarProd = new JButton("Cadastrar categoria");
		btnCadastrarProd.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent arg0) {
				btnCadastrarProd.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
			}
		});
		btnCadastrarProd.setBounds(75, 561, 465, 40);
		btnCadastrarProd.setBorder(null);
		btnCadastrarProd.setIcon(new ColorIcon(Color.DARK_GRAY, btnCadastrarProd.getWidth(), btnCadastrarProd.getHeight()));
		btnCadastrarProd.setHorizontalTextPosition(JButton.CENTER);
		btnCadastrarProd.setVerticalTextPosition(JButton.CENTER);
		btnCadastrarProd.setMargin(new Insets(0, 0, 0, 0));
		btnCadastrarProd.setBackground(Color.DARK_GRAY);
		btnCadastrarProd.setFont(new Font("Gotham Book", Font.PLAIN, 16));
		btnCadastrarProd.setFocusPainted(false);
		btnCadastrarProd.setForeground(Color.WHITE);
		panelCadastrar.add(btnCadastrarProd);
				...
				btnCadastrarProd.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						try {
							...
							produto.setCodigoProduto(cadCodigoProduto.getText());
							produto.setNomeProduto(cadNomeProduto.getText());
							produto.setDescricaoProduto(cadDescProduto.getText());
							produto.setCategoria(cadPrecoProduto.getText());
							produto.setPrecoUnitario(cadEstoqueProduto.getText());
							produto.setEstoqueProduto(cadClassificacaoProduto.getText());
