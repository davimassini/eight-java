...
public class IUCadastrarCategoria extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					IUCadastrarCategoria frame = new IUCadastrarCategoria();
	...
	JTextField cadCodigoCategoria = new JtextFieldSomenteNumeros(7);
	...
	private JTextField cadNomeCategoria;
	...
	public IUCadastrarCategoria() {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setFont(new Font("Open Sans", Font.PLAIN, 12));
		setBounds(100, 100, 630, 450);
		setResizable(false);
		setIconImage(Toolkit.getDefaultToolkit().getImage(IUCadastrarCategoria.class.getResource("/View/images/iconBarra.png")));	
		setUndecorated(true);
		setResizable(false);
		...
		panelCadastrar.setBounds(0, 30, 630, 420);
		...
		lblLogoLog.setIcon(new ImageIcon(IUCadastrarCategoria.class.getResource("/View/images/logo-footer-mini.png")));
		...
		lblSlogamLogin = DefaultComponentFactory.getInstance().createTitle("Digite abaixo as informa\u00E7\u00F5es para o cadastro da nova categoria");
		...
		cadCodigoCategoria.setBounds(75, 215, 465, 40);
		cadCodigoCategoria.setUI(new HintTextFieldUI("Código da categoria", true));
		panelCadastrar.add(cadCodigoCategoria);
		cadCodigoCategoria.setForeground(Color.BLACK);
		cadCodigoCategoria.setBackground(Color.WHITE);
		cadCodigoCategoria.setFont(new Font("Gotham Book", Font.PLAIN, 13));
		cadCodigoCategoria.setBorder(BorderFactory.createCompoundBorder(new LineBorder(Color.LIGHT_GRAY, 1, false), BorderFactory.createEmptyBorder(0, 10, 0, 0)));
		cadCodigoCategoria.setColumns(10);
		
		cadNomeCategoria = new JTextField();
		cadNomeCategoria.setUI(new HintTextFieldUI("Nome da categoria", true));
		cadNomeCategoria.setForeground(Color.BLACK);
		cadNomeCategoria.setFont(new Font("Gotham Book", Font.PLAIN, 13));
		cadNomeCategoria.setColumns(10);
		cadNomeCategoria.setBorder(BorderFactory.createCompoundBorder(new LineBorder(Color.LIGHT_GRAY, 1, false), BorderFactory.createEmptyBorder(0, 10, 0, 0)));
		cadNomeCategoria.setBackground(Color.WHITE);
		cadNomeCategoria.setBounds(75, 266, 465, 40);
		panelCadastrar.add(cadNomeCategoria);
		
		JButton btnCadastrarCat = new JButton("Cadastrar categoria");
		btnCadastrarCat.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent arg0) {
				btnCadastrarCat.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
			}
		});
		btnCadastrarCat.setBounds(75, 330, 465, 40);
		btnCadastrarCat.setBorder(null);
		btnCadastrarCat.setIcon(new ColorIcon(Color.DARK_GRAY, btnCadastrarCat.getWidth(), btnCadastrarCat.getHeight()));
		btnCadastrarCat.setHorizontalTextPosition(JButton.CENTER);
		btnCadastrarCat.setVerticalTextPosition(JButton.CENTER);
		btnCadastrarCat.setMargin(new Insets(0, 0, 0, 0));
		btnCadastrarCat.setBackground(Color.DARK_GRAY);
		btnCadastrarCat.setFont(new Font("Gotham Book", Font.PLAIN, 16));
		btnCadastrarCat.setFocusPainted(false);
		btnCadastrarCat.setForeground(Color.WHITE);
		panelCadastrar.add(btnCadastrarCat);
				...
				btnCadastrarCat.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						try {
							...
							categoria.setCodigoCategoria(cadCodigoCategoria.getText());
							categoria.setNomeCategoria(cadNomeCategoria.getText());
